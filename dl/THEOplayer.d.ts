 ...
 * @public
 */
export declare interface AddTrackEvent extends Event_2<'addtrack'> {
    /**
...
export declare interface Chromecast extends VendorCast, EventDispatcher<ChromecastEventMap> {
     ...
     */
    addEventListener<TType extends StringKeyOf<ChromecastEventMap>>(type: TType | readonly TType[], listener: EventListener_2<ChromecastEventMap[TType]>): void;
    /**
     * {@inheritDoc EventDispatcher.removeEventListener}
     */
    removeEventListener<TType extends StringKeyOf<ChromecastEventMap>>(type: TType | readonly TType[], listener: EventListener_2<ChromecastEventMap[TType]>): void;
}
...
export declare class ChromelessPlayer implements EventDispatcher<PlayerEventMap> {
     ...
     * {@inheritDoc EventDispatcher.addEventListener}
     */
    addEventListener<TType extends StringKeyOf<PlayerEventMap>>(type: TType | readonly TType[], listener: EventListener_2<PlayerEventMap[TType]>): void;
    /**
     * {@inheritDoc EventDispatcher.removeEventListener}
     */
    removeEventListener<TType extends StringKeyOf<PlayerEventMap>>(type: TType | readonly TType[], listener: EventListener_2<PlayerEventMap[TType]>): void;
    /**
     * The web audio API.
     *
     * @remarks
...
export declare interface EventDispatcher<TEventMap extends EventMap<StringKeyOf<TEventMap>>> {
     ...
     */
    addEventListener<TType extends StringKeyOf<TEventMap>>(type: TType | readonly TType[], listener: EventListener_2<TEventMap[TType]>): void;
    /**
     ...
     */
    removeEventListener<TType extends StringKeyOf<TEventMap>>(type: TType | readonly TType[], listener: EventListener_2<TEventMap[TType]>): void;
}
...
export declare interface MediaTrack extends Track, EventDispatcher<MediaTrackEventMap> {
     ...
     * {@inheritDoc EventDispatcher.addEventListener}
     */
    addEventListener<TType extends StringKeyOf<MediaTrackEventMap>>(type: TType | readonly TType[], listener: EventListener_2<MediaTrackEventMap[TType]>): void;
    /**
     * {@inheritDoc EventDispatcher.removeEventListener}
     */
    removeEventListener<TType extends StringKeyOf<MediaTrackEventMap>>(type: TType | readonly TType[], listener: EventListener_2<MediaTrackEventMap[TType]>): void;
}
 ...
 * @public
 */
export declare interface RemoveTrackEvent extends Event_2<'removetrack'> {
    /**
...
declare interface TextTrack_2 extends Track, EventDispatcher<TextTrackEventMap_2> {
     ...
     * {@inheritDoc EventDispatcher.addEventListener}
     */
    addEventListener<TType extends StringKeyOf<TextTrackEventMap_2>>(type: TType | readonly TType[], listener: EventListener_2<TextTrackEventMap_2[TType]>): void;
    /**
     * {@inheritDoc EventDispatcher.removeEventListener}
     */
    removeEventListener<TType extends StringKeyOf<TextTrackEventMap_2>>(type: TType | readonly TType[], listener: EventListener_2<TextTrackEventMap_2[TType]>): void;
}
 ...
 * @public
 */
export declare interface TrackChangeEvent extends Event_2<'change'> {
    /**
 ...
 * @public
 */
export declare interface TrackUpdateEvent extends Event_2<'update'> {
    /**
...
export declare interface UIRelatedContent extends RelatedContent, EventDispatcher<UIRelatedContentEventMap> {
     ...
     * {@inheritDoc EventDispatcher.addEventListener}
     */
    addEventListener<TType extends StringKeyOf<UIRelatedContentEventMap>>(type: TType | readonly TType[], listener: EventListener_2<UIRelatedContentEventMap[TType]>): void;
    /**
     * {@inheritDoc EventDispatcher.removeEventListener}
     */
    removeEventListener<TType extends StringKeyOf<UIRelatedContentEventMap>>(type: TType | readonly TType[], listener: EventListener_2<UIRelatedContentEventMap[TType]>): void;
}
 ...
 * @public
 */
export declare type YospaceId = 'YMID' | 'YTYP' | 'YSEQ' | 'YDUR' | 'YCSP';
